                ...
                <div className="items-center relative mt-8">
                    <div className="relative">
                        ...
                        <div className="relative lg:h-[700px] md:h-[450px] h-64 bg-center bg-cover rounded-t-md" style={{ backgroundImage: `url("${picture}")` }}>
                            <p className='absolute right-4 top-4 bg-white/50 rounded-md px-2 text-2xl font-bold text-blue-600'>$ {price} </p>
                            <div className='absolute bottom-11 shadow-md bg-slate-100/50 p-4 w-full shadow-md'>
                                <p className="capitalize font-bold"><span className="font-bold"><kbd className="kbd">Author: </kbd></span> {created_by}</p>
                            ...
                            <h2 className='card-title w-full p-2 absolute bottom-0 bg-black/50 text-white'>{title}</h2>
                        </div>
