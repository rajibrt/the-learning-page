        ...
        <div className="navbar bg-white/70 shadow-lg sticky top-0 z-40">
            ...
            <div className="navbar-end">
                ...
                >
                    <Link to='/profile'>
                        {user?.photoURL ?
                            <img className='rounded-full w-8 md:mr-0 mr-4' src={user?.photoURL} alt="" />
                            :
...

                {
                    user?.uid ?
                        <>
                            <Link to='/profile' className="btn btn-ghost md:flex hidden ">
                                {user?.displayName}
                            </Link>
                ...
                <label className="mx-4 swap swap-rotate">
